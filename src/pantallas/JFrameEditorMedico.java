 ...
 * @author Estudiante
 */
public class JFrameEditorMedico extends javax.swing.JFrame {
    ...
    public JFrameEditorMedico(JFrameMedico padre) {
        initComponents();
        this.padre = padre;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEditorMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameEditorMedico(new JFrameMedico(new JFrameCita(new JFrameGestordeCitas()))).setVisible(true);
            }
        });
    }
